...
namespace String.Extensions.Test.src
{
    public class KeeperTest
    {
        ...
        public void KeepAllSpecialCharactersTest(string testString, string expected)
        {
            string actual = testString.KeepAllSpecialCharacters();
        ...
        public void KeepOnlyLettersTest(string testString, string expected)
        {
